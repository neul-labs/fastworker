"""Client implementation for FastWorker."""
import asyncio
import logging
import os
from typing import Any, Optional, Dict
from fastworker.patterns.nng_patterns import SurveyorRespondentPattern, BusPattern, ReqRepPattern
from fastworker.tasks.models import Task, TaskPriority, TaskResult, TaskStatus, CallbackInfo
...
class Client:
    ...
    - FASTWORKER_DISCOVERY_ADDRESS: Discovery address (default: tcp://127.0.0.1:5550)
    - FASTWORKER_SERIALIZATION_FORMAT: Serialization format - JSON or PICKLE (default: JSON)
    - FASTWORKER_TIMEOUT: Task timeout in seconds (default: 30)
    - FASTWORKER_RETRIES: Number of retries for failed submissions (default: 3)
    """
    ...
    def __init__(self,
        ...
        self.timeout = timeout or int(os.getenv("FASTWORKER_TIMEOUT", "30"))
        self.retries = retries or int(os.getenv("FASTWORKER_RETRIES", "3"))
        self.running = False
