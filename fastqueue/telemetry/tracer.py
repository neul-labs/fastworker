"""OpenTelemetry tracing support for FastQueue."""
...
try:
    ...
    logger.debug("OpenTelemetry not available. Install with: pip install fastqueue[telemetry]")
...
def _initialize_tracer():
    ...
    if not OTEL_AVAILABLE:
        logger.warning("OpenTelemetry not available. Install with: pip install fastqueue[telemetry]")
        _tracer = NoOpTracer()
        return
